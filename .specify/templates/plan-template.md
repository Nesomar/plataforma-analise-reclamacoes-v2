...
Declare conformidade explícita com cada princípio de `.specify/memory/constitution.md`. Marque
✅ Conforme, ⚠ Exceção justificada (detalhar em Complexity Tracking) ou N/A com razão.
...
| IX. Observabilidade como Requisito | | |
| X. Resiliência Explícita | | |
| XI. Controle de Acesso que Falha Fechado | | |
| XII. Paridade Local/Produção sem Código Condicional | | |
| XIII. Skills Obrigatórias por Tipo de Tarefa | | |
| XIV. Gate de CI antes do Merge | | |
